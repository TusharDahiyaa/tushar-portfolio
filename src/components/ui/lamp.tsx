...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative pt-[150%] md:pt-36 h-dvh md:h-auto flex flex-col items-center justify-center overflow-hidden dark:bg-neutral-950 w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-v-950 blur-2xl"></div>
